...
import com.kr.commons.adapters.PasswordTypesAdapter
import com.kr.commons.extensions.*
import com.kr.commons.helpers.*
import com.kr.commons.interfaces.HashListener
import com.kr.commons.views.MyDialogViewPager
...
class SecurityDialog(val activity: Activity, val requiredHash: String, val showTabIndex: Int, val callback: (hash: String, type: Int, success: Boolean) -> Unit)
    ...
    init {
        ...
        dialog = AlertDialog.Builder(activity, R.style.AlertDialogStyle)
        ...
        Helper.adjustAlertDialogWidth(dialog!!, activity)
    }
