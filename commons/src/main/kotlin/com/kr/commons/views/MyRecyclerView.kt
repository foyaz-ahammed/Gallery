...
import com.kr.commons.interfaces.RecyclerScrollCallback
...
open class MyRecyclerView : RecyclerView {
    ...
    var listener: OnSwipeDirectListener? = null

    interface OnSwipeDirectListener {
        fun onSwipeDirect()
    }

    open fun setOnSwipeDirectListener(listener: OnSwipeDirectListener?) {
    ...
    override fun dispatchTouchEvent(ev: MotionEvent): Boolean {
        ...
        when (ev.action) {
            MotionEvent.ACTION_UP, MotionEvent.ACTION_CANCEL -> {
                ...
                if (ev.y - stPickPt > 350) {
                    Log.d("SWIPE DIRECTION", "DIRECTION$stPickPt")
                    listener?.onSwipeDirect()
                }
    ...
    private fun getItemPosition(e: MotionEvent): Int {
        ...
        val tag = v.getTag(VIEW_HOLDER_TAG)
