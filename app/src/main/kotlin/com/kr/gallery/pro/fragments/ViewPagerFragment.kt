...
abstract class ViewPagerFragment : Fragment() {
    ...
    protected var mIsCurrentFrag = false
    protected var mIsFullscreen = false

    abstract fun updateStateZoom(scale: Float)

    abstract fun getGesturesView(): ImageView?

    abstract fun setIsCurrentFrag(center: Boolean)

    abstract fun showPanoIcon()
    ...
    fun fullscreenToggled(isFullscreen: Boolean) {
