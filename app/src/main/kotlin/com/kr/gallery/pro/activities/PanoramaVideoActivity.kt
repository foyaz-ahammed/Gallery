...
import com.kr.gallery.pro.helpers.MIN_SKIP_LENGTH
...
open class PanoramaVideoActivity : SimpleActivity(), SeekBar.OnSeekBarChangeListener {
    ...
    private fun setupButtons() {
        ...
        video_time_holder.background = ResourcesCompat.getDrawable(resources, R.drawable.gradient_background, null)
