...
public class SliderView extends FrameLayout
    ...
    public void setLifecycle(Lifecycle lifeCycle, long delay) {
        if(lifeCycle != null)
    ...
    public void startAutoCycleAfterDelay() {
        if(isAutoCycle() && !mHandler.hasCallbacks(this)) {
    ...
    public void slideToNextPosition() {
        ...
        int curItem = mSliderPager.mCurItem;
        ...
        if (adapterItemsCount > 1) {
            ...
            if (mAutoCycleDirection == AUTO_CYCLE_DIRECTION_RIGHT) {
                mSliderPager.setCurrentItemInternal(curItem + 1, true);
            }
        }
