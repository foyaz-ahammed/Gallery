...
public class Indicator {
                ...
                if (progressTextViewId > 0) {
                    ...
                    if (view != null) {
                        if (view instanceof TextView) {
                            ...
                            mProgressTextView.setTypeface(null, Typeface.BOLD);
                        } else {
    ...
    private GradientDrawable getGradientDrawable() {
        ...
        if (mIndicatorType == IndicatorType.ROUNDED_RECTANGLE) {
            tvDrawable = (GradientDrawable) mContext.getResources().getDrawable(R.drawable.isb_indicator_rounded_corners, null);
        } else {
            tvDrawable = (GradientDrawable) mContext.getResources().getDrawable(R.drawable.isb_indicator_square_corners, null);
        }
